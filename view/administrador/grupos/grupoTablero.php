                                ...
                                <tbody>
                                    <?php foreach ($dataGrupo as $data) : ?>
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                                <form action="AsignarGrupoTablero" id="" method="POST">
                                                    <input type="text" value="<?php echo $data->id_grupo ?>" name="txt_id_grupo" id="txt_id_grupo" hidden>
                                                    <button type="submit" name="" id="" class="btn btn-outline-dark">Asignar Tableros</button>
                                                </form>
                                            </td>
                                        </tr>
                                        <?php /*}*/ ?>
